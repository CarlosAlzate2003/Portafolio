      ...
      <div className="flex-tools">
        ...
        <div className="flex-item">
          <a href="https://www.postman.com/downloads/" target="_blank">
            <img src="src\assets\svg\postman.svg" alt="postman_icon" />
          </a>
          <p>Postman</p>
        </div>
        <div className="flex-item">
          <a href="https://www.java.com/es/" target="_blank">
            <img src="src\assets\svg\java.svg" alt="java_icon" />
          </a>
          <p>Java</p>
        </div>
        <div className="flex-item">
          <a
            ...
            target="_blank"
          >
            <img src="src\assets\svg\php.svg" alt="php_icon" />
          </a>
          <p>php</p>
        </div>
        <div className="flex-item">
          <a href="https://www.postgresql.org/" target="_blank">
            <img src="src\assets\svg\postgres.svg" alt="postgres_icon" />
          </a>
          <p>PostgreSQL</p>
        </div>
        <div className="flex-item">
          <a
            ...
            target="_blank"
          >
            <img src="src\assets\svg\sqlserver.svg" alt="sqlserver_icon" />
          </a>
          <p>SQL Server</p>
        </div>
        <div className="flex-item">
          <a href="https://www.mysql.com/" target="_blank">
            <img src="src\assets\svg\mysql.svg" alt="mysql_icon" />
          </a>
          <p>MySQL</p>
        </div>
        <div className="flex-item">
          <a href="https://git-scm.com/" target="_blank">
            <img src="src\assets\svg\git.svg" alt="git_icon" />
          </a>
          <p>Git</p>
        </div>
        <div className="flex-item">
          <a
            ...
            target="_blank"
          >
            <img src="src\assets\svg\csharp.svg" alt="cshare_icon" />
          </a>
          <p>C#</p>
        </div>
        <div className="flex-item">
          <a
            ...
            target="_blank"
          >
            <img src="src\assets\svg\android.svg" alt="android_icon" />
          </a>
          <p>Android Studio</p>
        </div>
        <div className="flex-item">
          <a
            ...
            target="_blank"
          >
            <img src="src\assets\svg\microsoft.svg" alt="microsoft_icon" />
          </a>
